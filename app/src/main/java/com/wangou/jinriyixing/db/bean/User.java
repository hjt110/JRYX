...
public class User {
    ...
    public User(Long id, String token, String username, String sex, String headpic,
            String mobile, String signature, String birthday_time,
            String birthday_date, String province, String city, String town,
            String dynamicnum, String follownum, String fansnum) {
        this.id = id;
        this.token = token;
